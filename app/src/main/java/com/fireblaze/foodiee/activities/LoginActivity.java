...
import com.fireblaze.foodiee.fragments.LoginFragment;
import com.fireblaze.foodiee.fragments.SignUpFragment;
import com.fireblaze.foodiee.models.NotificationToken;
...
//        tabs.setupWithViewPager(mViewPager);
    ...
    private void signUpAsOrganizer(){
        ...
        mDatabase.child(Constants.RESTAURANT_KEYWORD).child(getUid()).setValue(restaurant);
        NewRestaurantActivity.navigate(LoginActivity.this);
        finish();
    }
    private void loginAsOrganizer(){

        mDatabase.child(Constants.RESTAURANT_KEYWORD).child(getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                intent.setClass(LoginActivity.this,RestaurantMainActivity.class);

                Restaurant restaurant = dataSnapshot.getValue(Restaurant.class);
                if(restaurant != null) {
                    //Check if the user is a valid restaurant
                    if (restaurant.getIsValid()) {
                        intent.setClass(LoginActivity.this,RestaurantMainActivity.class);
                    } else {
                        intent.setClass(LoginActivity.this,NewRestaurantActivity.class);
                    }
                } else {
                    intent.setClass(LoginActivity.this,NewRestaurantActivity.class);
                }
