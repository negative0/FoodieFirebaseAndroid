...
import com.fireblaze.foodiee.activities.LoginActivity;
...
public class UserOperations {
    ...
    private static void performDeletion(final Context context, final FirebaseUser user,final boolean isOrganizer,final DatabaseReference ref){
        final String UID = user.getUid();
        if(isOrganizer){
            ref.child(Constants.RESTAURANT_KEYWORD).child(UID).setValue(null);
            ref.child(Constants.RESTAURANT_IMAGE).child(UID).setValue(null);
        }
        user.delete()
